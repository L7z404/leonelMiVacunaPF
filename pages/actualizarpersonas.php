<?php
    ...
    $sqlUpdate = "UPDATE datos_persona SET nombre = '$nombre', apaterno = '$apaterno', amaterno = '$amaterno', 
                  curp = '$infocurp', fecNac = '$fecNac', sexo = '$sexo', postracion = '$postracion',  
                  diabetes = '$diabetes', hipertension = '$hiperten', id_municipio = '$municipio', 
                  cp = '$codigoP', telefono = '$telefono', telefono2 = '$telefono2', email = '$correo',
                  emailap = '$correo2', dom_datos = '$domDatos', id_entidad_lugar = '$entidadLugar' 
                    WHERE id = '$id'";
    $conn->exec($sqlUpdate);
...
<div id="all_cabeza">
    ...
    <div id="pie_cabeza" style="color: white; text-align: center; padding: 0 0 10px 0; font-family: 'Comic Sans MS', serif; font-size: 30px">Actualización de Datos de Personas</div>
