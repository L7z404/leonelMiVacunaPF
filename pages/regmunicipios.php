...
$sql = 'SELECT m.id, m.municipio, e.entidad FROM municipios m INNER JOIN entidades e on m.id_municipio = e.id_municipio';
$stmt = $conn->query($sql);
$rows = $stmt->fetchAll();
...
<head>
    ...
    <title>Registros Municipios</title>
    <style>
        table{
            border: 5px #9E7E4F;
        }
...
<div id="all_cabeza">
    ...
    <div id="pie_cabeza" style="color: white; text-align: center; padding: 0 0 10px 0; font-family: 'Comic Sans MS', serif; font-size: 30px">Administración de Datos de Municipios</div>
