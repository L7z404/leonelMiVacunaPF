...
<body>
    <div id="all_cabeza">
        ...
        <div style="float: right; margin: 0 10% 0 0"><a href="pages/login.php"><button id="inis">Iniciar Sesión</button></a></div>
        <div id="pie_cabeza" style="color: white; text-align: center; padding: 0 0 10px 0;"> <strong style=" margin: 0 0 0 20%">Se recomienda Chrome para la mejor experiencia</strong> <img style="height: 30px" src="images/chromeicon.png"></div>
